const createFunc = (version, manifest) => {
    ...
    function enqueue_vue_scripts() {
        wp_enqueue_script( 'vue-app', get_stylesheet_directory_uri() . '/${manifest['index.html']['file']}', array(), '${version}', true );
        wp_enqueue_style( 'vue-app', get_stylesheet_directory_uri() . '/${manifest['index.css']['file']}', array(), '${version}' );
      }
